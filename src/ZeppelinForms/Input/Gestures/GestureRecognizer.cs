...
public abstract class GestureRecognizer
{
    ...
    /// <summary>Забрать системный захват на время жеста.</summary>
    /// <remarks>
    /// Нужно тем жестам, что продолжаются за пределами окна: без захвата
    /// движения мыши туда не доходят, и перетаскивание залипает.
    /// Касанию это безразлично — экран и так отдаёт контакт целиком, —
    /// поэтому захват берётся по требованию, а не всеми подряд.
    /// Отпускать не надо: Form снимет его вместе с концом контакта.
    /// </remarks>
